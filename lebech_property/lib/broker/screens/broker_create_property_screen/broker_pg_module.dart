...
class BrokerPgPropertyDetailsModule extends StatelessWidget {
  BrokerPgPropertyDetailsModule({Key? key}) : super(key: key);
...
class BrokerPgTenantDetailsModule extends StatelessWidget {
  BrokerPgTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BrokerCreatePropertyScreenController>();
...
class BrokerPgOwnerDetailsModule extends StatelessWidget {
  BrokerPgOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BrokerCreatePropertyScreenController>();
