...
class BrokerRentPropertyDetailsModule extends StatelessWidget {
  BrokerRentPropertyDetailsModule({Key? key}) : super(key: key);
...
class BrokerRentTenantDetailsModule extends StatelessWidget {
  BrokerRentTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BrokerCreatePropertyScreenController>();
...
class BrokerRentOwnerDetailsModule extends StatelessWidget {
  BrokerRentOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BrokerCreatePropertyScreenController>();
