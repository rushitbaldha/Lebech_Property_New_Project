...
CategoryPropertyModel categoryPropertyModelFromJson(String str) => CategoryPropertyModel.fromJson(json.decode(str));

String categoryPropertyModelToJson(CategoryPropertyModel data) => json.encode(data.toJson());
...
class CategoryPropertyModel {
  ...
  factory CategoryPropertyModel.fromJson(Map<String, dynamic> json) => CategoryPropertyModel(
    status: json["status"],
