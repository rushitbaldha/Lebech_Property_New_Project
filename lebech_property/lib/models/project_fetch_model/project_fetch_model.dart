...
ProjectFetchModel projectFetchModelFromJson(String str) => ProjectFetchModel.fromJson(json.decode(str));

String projectFetchModelToJson(ProjectFetchModel data) => json.encode(data.toJson());

class ProjectFetchModel {
  ProjectFetchModel({
  ...
  factory ProjectFetchModel.fromJson(Map<String, dynamic> json) => ProjectFetchModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    images: List<PropertyImage>.from(json["images"].map((x) => x) ?? {}),
