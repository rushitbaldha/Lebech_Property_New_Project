...
import '../../controllers/builder_create_property_screen_controller/builder_create_property_screen_controller.dart';


class BuilderPgPropertyDetailsModule extends StatelessWidget {
  BuilderPgPropertyDetailsModule({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            screenController.propertyTypeValue.sub == "house"
                ? Expanded(child: balconiesDropDownModule(context)) : Container(),
            const SizedBox(width: 8),
            screenController.propertyTypeValue.sub == "house" ||
                screenController.propertyTypeValue.sub == "office" ||
                screenController.propertyTypeValue.sub == "textile"
                ? Expanded(child: floorNumberFieldModule()) : Container(),
          ],
        ),
        ...
        Row(
          ...
          children: [
            screenController.propertyTypeValue.sub == "house" ||
                screenController.propertyTypeValue.sub == "office" ||
                screenController.propertyTypeValue.sub == "textile"
                ? Expanded(child: totalFloorFieldModule()) : Container(),
            const SizedBox(width: 8),
            screenController.propertyTypeValue.sub == "house" ||
                screenController.propertyTypeValue.sub == "office" ||
                screenController.propertyTypeValue.sub == "textile"
                ? Expanded(child: furnishedDropDownModule(context)) : Container(),
          ],
        ),
        ...
        Row(
          ...
          children: [
            screenController.propertyTypeValue.sub == "house" ||
                ...
                ? Expanded(child: bathroomsDropDownModule(context)) : Container(),
            const SizedBox(width: 8),
            screenController.propertyTypeValue.sub == "house" ||
                screenController.propertyTypeValue.sub == "office" ||
                screenController.propertyTypeValue.sub == "textile"
                ? Expanded(child: acDropDownModule(context)) : Container(),
          ],
        ),
        ...
        Row(
          ...
          children: [
            screenController.propertyTypeValue.sub == "house"
                ? Expanded(child: bedDropDownModule(context)) : Container(),
            const SizedBox(width: 8),
            screenController.propertyTypeValue.sub == "house"
                ? Expanded(child: wardrobeDropDownModule(context)) : Container(),
          ],
        ),
        ...
        Row(
          ...
          children: [
            screenController.propertyTypeValue.sub == "house"
                ? Expanded(child: tvDropDownModule(context)) : Container(),
            const SizedBox(width: 8),
        ...
        screenController.propertyTypeValue.sub == "house" ||
            ...
            ? const Header1(text: "Area") : Container(),
        screenController.propertyTypeValue.sub == "house" ||
            screenController.propertyTypeValue.sub == "office" ||
            screenController.propertyTypeValue.sub == "textile" ||
            screenController.propertyTypeValue.sub == "industrial" ||
        ...
        screenController.propertyTypeValue.sub == "plot"
            ? varVighaYardFieldModule() : Container(),
        ...
        screenController.propertyTypeValue.sub == "house"
            ...
            || screenController.propertyTypeValue.sub == "industrial"
            || screenController.propertyTypeValue.sub == "shed"
            ? ageOfConstructionDropDownModule(context) : Container(),
        const SizedBox(height: 8),
        ...
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? otherDetailsRadioButtonModule() : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? Row(
        ...
        const Divider(),
        const Header1(text: "Rent/ Lease Detail"),
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Expanded(child: monthlyRentFieldModule()),
            const SizedBox(width: 8),
        ...
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Expanded(child: securityDepositeFieldModule()),
            const SizedBox(width: 8),
            Expanded(child: maintenanceChargeFieldModule()),
          ],
        ),
        ...
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Expanded(child: maintenanceTenureDropDownModule(context)),
            const SizedBox(width: 8),
            Expanded(child: propertyTaxPayableDropDownModule(context)),
          ],
        ),

        perSrFtRateFieldModule(),
      ...
      children: [
        ...
        TypeAheadField(
          ...
          textFieldConfiguration: TextFieldConfiguration(
            ...
            decoration: builderCreatePropertyFieldDecoration(hintText: '',screenController: screenController),
          ),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          keyboardType: TextInputType.number,
          decoration: builderCreatePropertyFieldDecoration(
  ...
  // Monthly Rent
  Widget monthlyRentFieldModule() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Header2(text: "Monthly Rent"),
        TextFormField(
        ...
        Row(
          children: [
            Obx(
                ...
                checkColor: Colors.white,
                fillColor: MaterialStateProperty.resolveWith((states) => AppColors.blueColor),
                value: screenController.isMonthlyRentNegotiable.value,
                onChanged: (bool? value) {
                  screenController.isMonthlyRentNegotiable.value = !screenController.isMonthlyRentNegotiable.value;
                  log("isMonthlyRentNegotiable : ${screenController.isMonthlyRentNegotiable.value}");
                },
              ),
            ),
  ...
  // Security Deposite
  Widget securityDepositeFieldModule() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Header2(text: "Security Deposite"),
        TextFormField(
          controller: screenController.securityDepositeController,
          keyboardType: TextInputType.number,
          decoration: builderCreatePropertyFieldDecoration(hintText: '',screenController: screenController),
          // validator: (value) => FieldValidations().validateFullName(value!),
        )
  ...
  // Maintenance Charge
  Widget maintenanceChargeFieldModule() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Header2(text: "Maintenance Charge"),
        TextFormField(
          controller: screenController.maintenanceChargeController,
          keyboardType: TextInputType.number,
          decoration: builderCreatePropertyFieldDecoration(hintText: '',screenController: screenController),
          // validator: (value) => FieldValidations().validateFullName(value!),
        )
  ...
  Widget maintenanceTenureDropDownModule(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Header2(text: "Maintenance Tenure"),
        Container(
          padding: const EdgeInsets.only(left: 10),
          width: Get.width, //gives the width of the dropdown button
          decoration: BoxDecoration(
          ...
          child: Theme(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: screenController.maintenanceTenureValue,
                items: screenController.maintenanceTenureList
                    .map<DropdownMenuItem<String>>((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(
                ...
                onChanged: (value) {
                  screenController.isLoading(true);
                  screenController.maintenanceTenureValue = value!;
                  screenController.isLoading(false);
                },
              ),
            ),
  ...
  Widget propertyTaxPayableDropDownModule(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Header2(text: "Property Tax Payable By"),
        Container(
          padding: const EdgeInsets.only(left: 10),
          width: Get.width, //gives the width of the dropdown button
          decoration: BoxDecoration(
          ...
          child: Theme(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: screenController.propertyTaxPayableByValue,
                items: screenController.propertyTaxPayableByList
                    .map<DropdownMenuItem<String>>((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(
                ...
                onChanged: (value) {
                  screenController.isLoading(true);
                  screenController.propertyTaxPayableByValue = value!;
                  screenController.isLoading(false);
                },
              ),
            ),
...
class BuilderPgTenantDetailsModule extends StatelessWidget {
  BuilderPgTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        screenController.propertyTypeValue.sub == "house" ? const Header1(text: "Tenants You Prefer") : Container(),
        screenController.propertyTypeValue.sub == "house" ? _bachelors() : Container(),
        screenController.propertyTypeValue.sub == "house" ? _nonVegetarians() : Container(),
        screenController.propertyTypeValue.sub == "house" ? _pets() : Container(),
        screenController.propertyTypeValue.sub == "house" ? _companyLease() : Container(),
        screenController.propertyTypeValue.sub == "house" ? const Divider() : Container(),

        const Header1(text: "Additional Features"),
        screenController.propertyTypeValue.sub == "house" ? _additionalRoom() : Container(),
        _facing(context),
        screenController.propertyTypeValue.sub == "house" ? _overLooking() : Container(),
        ...
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? const Header1(text: "Flooring and Amenities") : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? _flooring() : Container(),
          ...
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Radio<TenantBachelors>(
                    value: TenantBachelors.no_matter,
                    groupValue: screenController.tenantBachelors,
                    onChanged: (value) {
                      screenController.isLoading(true);
                      screenController.tenantBachelors = value!;
          ...
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Radio<TenantNonVegetarian>(
                    value: TenantNonVegetarian.no_matter,
                    groupValue: screenController.tenantNonVegetarian,
                    onChanged: (value) {
                      screenController.isLoading(true);
                      screenController.tenantNonVegetarian = value!;
          ...
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Radio<TenantCompanyLease>(
                    value: TenantCompanyLease.no_matter,
                    groupValue: screenController.tenantCompanyLease,
                    onChanged: (value) {
                      screenController.isLoading(true);
                      screenController.tenantCompanyLease = value!;
...
class BuilderPgOwnerDetailsModule extends StatelessWidget {
  BuilderPgOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        screenController.propertyTypeValue.sub == "house" ? const Header1(text: "Tenant Preferences") : Container(),
        screenController.propertyTypeValue.sub == "house" ? _visitorsRestriction() : Container(),
        screenController.propertyTypeValue.sub == "house" ? _tenantRestrictionFieldModule() : Container(),
        screenController.propertyTypeValue.sub == "house" ? _tenantPrefer() : Container(),
        screenController.propertyTypeValue.sub == "house" ? const Divider() : Container(),
        ...
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? const Header1(text: "Question & Answer") : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? _securityFeaturesFieldModule() : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? _occupantsStayFieldModule() : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? _crossViolationModule() : Container(),
        screenController.propertyTypeValue.sub == "house"
            || screenController.propertyTypeValue.sub == "office"
            || screenController.propertyTypeValue.sub == "textile"
            ? _commonWallModule() : Container(),
