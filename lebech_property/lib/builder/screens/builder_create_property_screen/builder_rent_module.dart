...
class BuilderRentPropertyDetailsModule extends StatelessWidget {
  BuilderRentPropertyDetailsModule({Key? key}) : super(key: key);
...
class BuilderRentTenantDetailsModule extends StatelessWidget {
  BuilderRentTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
...
class BuilderRentOwnerDetailsModule extends StatelessWidget {
  BuilderRentOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
