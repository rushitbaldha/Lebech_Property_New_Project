...
class BuilderSalePropertyDetailsModule extends StatelessWidget {
  BuilderSalePropertyDetailsModule({Key? key}) : super(key: key);
...
class BuilderSaleTenantDetailsModule extends StatelessWidget {
  BuilderSaleTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
...
class BuilderSaleOwnerDetailsModule extends StatelessWidget {
  BuilderSaleOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<BuilderCreatePropertyScreenController>();
