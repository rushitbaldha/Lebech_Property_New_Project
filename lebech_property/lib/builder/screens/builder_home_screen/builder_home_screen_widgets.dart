...
class BuilderPropertyListModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: builderHomeScreenController.builderPropertyList.length,
      shrinkWrap: true,
      physics: const BouncingScrollPhysics(),
      itemBuilder: (context, i) {
        SellerPropertyDatum propertySingleItem = builderHomeScreenController.builderPropertyList[i];
