...
SubCategoryWisePropertyModel subCategoryWisePropertyModelFromJson(String str) => SubCategoryWisePropertyModel.fromJson(json.decode(str));

String subCategoryWisePropertyModelToJson(SubCategoryWisePropertyModel data) => json.encode(data.toJson());

class SubCategoryWisePropertyModel {
  SubCategoryWisePropertyModel({
  ...
  factory SubCategoryWisePropertyModel.fromJson(Map<String, dynamic> json) => SubCategoryWisePropertyModel(
...
class Datum {
  ...
  SubCategoryCity city;
  SubCategoryArea area;
  User user;
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    city: SubCategoryCity.fromJson(json["city"] ?? {}),
    area: SubCategoryArea.fromJson(json["area"] ?? {}),
...
class SubCategoryCity {
  ...
  factory SubCategoryCity.fromJson(Map<String, dynamic> json) => SubCategoryCity(
    id: json["id"] ?? 0,
    name: json["name"] ?? "",
    status: json["status"] ?? "",
...
class SubCategoryArea {
  ...
  factory SubCategoryArea.fromJson(Map<String, dynamic> json) => SubCategoryArea(
    id: json["id"] ?? 0,
    name: json["name"] ?? "",
    status: json["status"] ?? "",
    stateId: json["state_id"] ?? 0,
