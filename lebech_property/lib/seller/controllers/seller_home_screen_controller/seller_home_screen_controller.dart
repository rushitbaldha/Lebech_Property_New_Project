...
class SellerHomeScreenController extends GetxController {
  ...
  List<SellerPropertyDatum> sellerPropertyList = [];
  ...
  Future<void> getSellerAllPropertyFunction() async {
    isLoading(true);
    String url = ApiUrl.getSellerAllPropertyApi;
    ...
    try {
      ...
      if(isSuccessStatus.value) {
        ...
        sellerPropertyList.addAll(propertyListModule.data.data);
        log("sellerPropertyList : ${sellerPropertyList.length}");
      } else {
