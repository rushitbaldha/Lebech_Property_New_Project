...
class PgPropertyDetailsModule extends StatelessWidget {
  PgPropertyDetailsModule({Key? key}) : super(key: key);
...
class PgTenantDetailsModule extends StatelessWidget {
  PgTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<SellerCreatePropertyScreenController>();
...
class PgOwnerDetailsModule extends StatelessWidget {
  PgOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<SellerCreatePropertyScreenController>();
