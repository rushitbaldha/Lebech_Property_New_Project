...
class RentPropertyDetailsModule extends StatelessWidget {
  RentPropertyDetailsModule({Key? key}) : super(key: key);
...
class RentTenantDetailsModule extends StatelessWidget {
  RentTenantDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<SellerCreatePropertyScreenController>();
...
class RentOwnerDetailsModule extends StatelessWidget {
  RentOwnerDetailsModule({Key? key}) : super(key: key);
  final screenController = Get.find<SellerCreatePropertyScreenController>();
